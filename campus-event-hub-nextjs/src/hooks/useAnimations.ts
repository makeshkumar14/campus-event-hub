 ...
 */
export const useCounterAnimation = (ref: RefObject<HTMLElement | null>, target: number, speed: number = 200) => {
  useEffect(() => {
 ...
 */
export const useTiltEffect = (ref: RefObject<HTMLElement | null>) => {
  useEffect(() => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      orbs.forEach((orb, index) => {
        ...
        (orb as HTMLElement).style.transform = `translate(${scrolled * speed}px, ${scrolled * speed}px)`;
      });
    };
